...
public class BSTree<T extends Comparable<? super T>> {
   ...
   public int countBetween(T a,T b){                         // ED209
     return countBetween(root,a,b);
   }

   private int countBetween(BSTNode<T> n, T a, T b){
     if(n==null) return 0;
     if(n.getValue().compareTo(a) >= 0 && n.getValue().compareTo(b) <= 0) return 1 + countBetween(n.getRight(),a,b) + countBetween(n.getLeft(),a,b);
     return countBetween(n.getRight(),a,b) + countBetween(n.getLeft(),a,b);
   }
}
